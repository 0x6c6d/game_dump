// gcc wolfenstein.c -lSDL2 -lm -o wolfenstein
// credits: https://github.com/jdah/doomenstein-3d/
...
int main(int argc, char *argv[]) {
  ASSERT(!SDL_Init(SDL_INIT_VIDEO), "failed to initialize SDL: %s\n",
         SDL_GetError());

  state.window = SDL_CreateWindow("WOLFENSTEIN", SDL_WINDOWPOS_CENTERED_DISPLAY(0),
  ...
  state.pos = (v2){2, 2};
  state.dir = normalize(((v2){1.0f, 0.5f}));
